  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="With Restaurant Booking Engine, experience the seamless way to reserve tables and manage reservations. Empowering restaurants, delighting customers."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`With Restaurant Booking Engine, experience the seamless way to reserve tables and manage reservations. Empowering restaurants, delighting customers.`}
            </Text>
            <Box
